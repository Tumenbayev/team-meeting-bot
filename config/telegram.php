...
return [
    ...
    |
    */
    'bot_token' => env('430397085:AAFkl-xLWi_y16z2tmw_ZaSHLLBGVeVseeE', '430397085:AAFkl-xLWi_y16z2tmw_ZaSHLLBGVeVseeE'),
    ...
    */
    'commands' => [
        ...
        App\Http\Commands\JoinCommand::class,
        App\Http\Commands\LeaveCommand::class,
    ]
];
